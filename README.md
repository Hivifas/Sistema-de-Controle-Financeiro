...
2 Adicionar Despesa: Registra saídas informando a categoria (ex: alimentação, transporte) e o valor.

3 Listar Despesas: Exibe todas as despesas cadastradas de forma organizada.

4 Ver Saldo: Calcula e mostra o saldo disponível (Receitas - Despesas).
...
Passo a Passo
Clone ou baixe o arquivo do código:
Salve o arquivo com a extensão .py (exemplo: controle_financeiro.py).
